...
- **379 backend tests** — feature maths, timestamp fidelity, all attack types, benign-traffic false-positive guard, DNS aggregation, threshold provenance, IPv6, hashing, tamper detection, custody-chain breakage, certificate refusal on failed integrity, AES-256 GCM encryption, evidence posture calculation.
